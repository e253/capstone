...
ktest: kernel_test.cpp common.o v7.o v8.o v9.o v10.o
	...
	g++ -march=native -g -DKERNEL_VER=10 kernel_test.cpp common.o v10.o -o ktest10.exe && \
...
egtest: egemv_test.cpp common.o v7.o v8.o v8_omp.o v9.o v10.o
	...
	./egtest7.exe && ./egtest8.exe && ./egtest8omp.exe && ./egtest9.exe && ./egtest10.exe
...
bench: egemv_bench.cpp common.o v7.o v8.o v8_omp.o v9.o v10.o
	...
	./bench7.exe && ./bench8.exe && ./bench8omp.exe && ./bench9.exe && ./bench10.exe
